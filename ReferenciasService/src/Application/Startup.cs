...
using OSPeConTI.ReferenciasService.Application.Helper;
using OSPeConTI.ReferenciasService.Infrastructure;
using Microsoft.EntityFrameworkCore;
using MediatR;
using System.Reflection;
using OSPeConTI.ReferenciasService.Domain.Entities;
using OSPeConTI.ReferenciasService.Infrastructure.Repositories;
...
using OSPeConTI.ReferenciasService.BuildingBlocks.EventBusRabbitMQ;
using Autofac;
using Microsoft.Extensions.Logging;
using OSPeConTI.ReferenciasService.BuildingBlocks.EventBus;
...
namespace OSPeConTI.ReferenciasService.Application
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IEstadoCivilRepository), typeof(EstadoCivilRepository));
            services.AddScoped(typeof(INacionalidadRepository), typeof(NacionalidadRepository));
            services.AddScoped(typeof(IParentescoRepository), typeof(ParentescoRepository));
            ...
            services.AddScoped(typeof(IProvinciaRepository), typeof(ProvinciaRepository));
            services.AddScoped(typeof(ILocalidadRepository), typeof(LocalidadRepository));
            ...
            services.AddScoped<IParentescoQueries>(conns => new ParentescoQueries(Configuration.GetConnectionString("DefaultConnection")));
            services.AddDbContext<ReferenciasContext>(opt =>
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ReferenciasContext ReferenciasContext)
        {
